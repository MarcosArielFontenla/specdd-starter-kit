...
try{
  ...
  console.log(JSON.stringify({ui:'PASS',runtime:'SIMULATED',flow:'BA create/edit/analyze/adopt/resolve/approve/project + SpecDD canonicalize + QA assign/suggest/adopt/review/approve/case/coverage/defect/reload + fail/cancel/stale/XSS',desktop:true,mobile:true,pageErrors:0,evidence:screenshots}));
