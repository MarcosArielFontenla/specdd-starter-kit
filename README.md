...
| [`packages/artifact-model`](packages/artifact-model/) | `@specdd/artifact-model` — versioned role artifacts, traceability graph, [BA domain](packages/artifact-model/BA.md) and [governed SpecDD projection](packages/artifact-model/PROJECTION.md). |
