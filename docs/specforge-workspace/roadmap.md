...
| 7 — MVP QA | Accepted | [Spec](specs/phase-7.md) y [ADR](adrs/0007-local-qa-workspace.md) | MVP local aceptado; defecto visual corregido y verificado por el usuario; commit/push separados pendientes; sin deploy | [Evidencia](phases/phase-7.md), Artifact 98/98, Workspace 28/28 y E2E desktop/mobile simulado PASS, incluida regresión visual tras F5 | Gate humano, subject exacto, `qa-approve` v15, persistencia tras F5 y corrección visual verificados, 2026-09-10 |
