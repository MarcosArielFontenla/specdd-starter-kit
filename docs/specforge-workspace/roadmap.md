...
| 6 — Dominio QA | Accepted | [Spec](specs/phase-6.md) y [ADR](adrs/0006-qa-domain-and-evidence-boundaries.md) | Contratos, capability, coverage y gate publicados en `main` | [Evidencia](phases/phase-6.md) | Aceptación humana, commit `bfb2914` y CI 18/18 verde, 2026-09-10 |
| 7 — MVP QA | Accepted | [Spec](specs/phase-7.md) y [ADR](adrs/0007-local-qa-workspace.md) | Publicada en `main`; defecto visual corregido y verificado; sin deploy | [Evidencia](phases/phase-7.md), Artifact 98/98, Workspace 28/28, E2E PASS y CI 18/18 | Gate humano, commit `aa69bf5` y CI verde, 2026-09-11 |
| 8 — Lectura PM | Accepted | [Spec](specs/phase-8.md) y [ADR](adrs/0008-evidence-backed-pm-read-model.md) | Read model y UI local aceptados; sin autoría PM | [Evidencia](phases/phase-8.md), Workspace 29/29 y E2E desktop/mobile PASS | Gate humano y persistencia tras F5 verificados; desconocido/parcial/bloqueado explícitos, 2026-09-11 |
